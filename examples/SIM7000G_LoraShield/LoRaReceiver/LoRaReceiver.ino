 ...
 * @date      2025-09-10
 * @note      Examples only support SIM7000G  + LoRa Shield
 */
...
void setup()
{
    ...
    Serial.println("LoRaReceiver only support SIM7000G  + LoRa Shield , see  https://github.com/Xinyuan-LilyGO/LilyGo-Modem-Series/issues/357");
